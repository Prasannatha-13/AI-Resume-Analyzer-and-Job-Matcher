...
function Home(){
    ...
    return( 
  <>
 <div className="bg-[url('/project.png')]  h-screen bg-cover bg-center bg-no-repeat bg-blend-multiply mb-24">
    ...
    <div className='flex gap-6'>
        <div className='relative group h-0'>
          <button onClick={()=>{navigate('/signup')}} className='bg-blue-500 flex gap-2 ml-14 mt-10 py-3 p-6 border rounded-lg font-serif text-white text-xl  hover:scale-110 hover:bg-green-600  transition duration-700 ease-in-out cursor-pointer'>
     ...
     <span className="
      ...
      border border-white
    ">
      Signup before uploading resume
    </span>
  )}
     </div>
     <div className='relative group h-0'>
        <button onClick={()=>{navigate('/signup')}} className=" text-xl mt-10 py-3 p-6 rounded-lg hover:curser-pointer  relative overflow-hidden border border-blue-500 bg-white px-6 font-semibold group">
