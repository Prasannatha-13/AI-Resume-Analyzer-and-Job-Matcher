...
function Results (){
    return(
      <>
      <h1 className='text-3xl text-center font-bold items-center m-14  '>Smart Analysis<br/> Better Oppurtunities</h1>
      ...
      <div className='flex justify-center gap-6 m-3 mb-24 bg-green-50 '>
